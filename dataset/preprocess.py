...
import argparse
import time
from core.utils.data_frame_parser import DataFrameParser
from core.utils.numpytupledataset import NumpyTupleDataset
from core.utils.smile_to_graph import GGNNPreprocessor
import pdb
...
NumpyTupleDataset.save(f'dataset/{data_name.lower()}_kekulized.npz', dataset)
