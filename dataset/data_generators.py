...
def preprocess(data_dir='../dataset', dataset='sbm', measure_train_mmd=False):
    filename = f'{data_dir}/'
    if dataset == 'sbm':
        filename += 'sbm_200.pt'
    elif dataset == 'planar':
    ...
    if os.path.isfile(filename):
        ...
        if measure_train_mmd:
            ...
            from core.evaluation.stats import degree_stats, orbit_stats_all, clustering_stats, spectral_stats, \
