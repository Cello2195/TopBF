...
if __name__ == "__main__":
    data_list_train = MOSESDataset(root='data', split='train')
    data_list_val = MOSESDataset(root='data', split='val')
    data_list_test = MOSESDataset(root='data', split='test')
    process_graphs(data_list_test, 27)
    pdb.set_trace()
    # max_nodes: 27