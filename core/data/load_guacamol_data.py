...
if __name__ == "__main__":
    data_list_train = GuacamolDataset(root='data', split='train')
    data_list_val = GuacamolDataset(root='data', split='val')
    data_list_test = GuacamolDataset(root='data', split='test')
    pdb.set_trace()
    # max_nodes: 88