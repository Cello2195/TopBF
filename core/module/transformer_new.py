...
from core.utils.graph_utils import mask_x, mask_adjs, pow_tensor
from core.module.layers import XEyTransformerLayer
import pdb
...
class GraphTransformer(nn.Module):
    ...
    def forward(self, X, E, y, node_mask):
        ...
        E = mask_adjs(E.permute(0,3,1,2), node_mask).permute(0,2,3,1) * diag_mask
