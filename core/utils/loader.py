...
from core.module.transformer_new import GraphTransformer, GraphTransformer_Mol
...
def load_data(config, get_graph_list=False):
    if config.dataset.name in ['QM9', 'ZINC250k', 'ZINC250k_mini']:
        from core.utils.data_loader_mol import dataloader
