...
def dataloader(config, get_graph_list=False):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=config.optimization.batch_size, shuffle=True)
    test_dataloader = DataLoader(test_dataset, batch_size=config.optimization.batch_size, shuffle=True)
